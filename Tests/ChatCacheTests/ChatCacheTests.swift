...
final class CacheManagerTests: XCTestCase, CacheLogDelegate {
    ...
    func testManagers_whenLoadPersistentManager_initAllManagers() {
        ...
        sut.switchToContainer(userId: 1) {
            ...
            XCTAssertNotNil(self.sut.forwardInfo, "Expected the forwardInfo to be not nil, but it is nil.")
            ...
            XCTAssertNotNil(self.sut.replyInfo, "Expected the replyInfo to be not nil, but it is nil.")
