...
Thank you for considering contributing to ChatCache.

Please know that everyone is welcome to contribute to ChatCache.
...
ChatCache is an open source project and we encourage contributions
from the community.
...
All changes to ChatCache source must go through the PR review process before
...
ChatCache is a Swift package. If you're new to Swift package manager,
...
4. Build ChatCache from the command line by running:
