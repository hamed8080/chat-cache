...
public final class CacheTagParticipantManager: CoreDataProtocol {
    ...
    public func insert(models: [TagParticipant]) {
    ...
    public func first(with id: Int, _ completion: @escaping (CDTagParticipant?) -> Void) {
        context.perform {
    ...
    public func find(predicate: NSPredicate, _ completion: @escaping ([CDTagParticipant]) -> Void) {
        context.perform {
            let req = CDTagParticipant.fetchRequest()
    ...
    public func delete(_ models: [TagParticipant]) {
